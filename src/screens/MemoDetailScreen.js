  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <CircleButton color="white" style={styles.editButton} onPress={() => {this.props.navigation.navigate('MemoEdit', { memo, returnMemo: this.returnMemo.bind(this) })}}>+</CircleButton>
      </View>
    )
  }
}
